...
const baseStyles = ({ componentName, disabled, startIcon, theme, variant }: InputBaseProps & { theme: Theme }) => {
	...
	return css`
		...
		> fieldset {
			...
			> legend {
				...
				padding: 0;
				pointer-events: none;
				transition: transform 150ms ease-in-out, font-size 150ms ease-in-out, max-width 30ms ease-in-out;
				white-space: nowrap;
				width: auto;
				> label {
					color: inherit;
