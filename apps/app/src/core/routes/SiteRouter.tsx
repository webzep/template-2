...
import { SignInPage } from '@/features/authentication/SignInPage/SignInPage';
...
const siteRoutes = (
	<Route element={<AppBaseContainer />}>
		...
		<Route element={<AppLayoutWithNavBar appbar={<AppBar />} />}>
			...
			<Route path={PathNames.PRIVACY_POLICY} element={<PrivacyPolicyPage />} />
			<Route path={PathNames.SUPPORT} element={<SupportPage />} />
			<Route path={PathNames.TERMS_OF_SERVICE} element={<TermsOfServicePage />} />
