...
export const SignInBackground: FC = () => {
	...
	const containerWidth = shouldUseHeight ? (size.height * svgWidth) / svgHeight : size.width;
	const containerHeight = shouldUseHeight ? size.height : (size.width * svgHeight) / svgWidth;
