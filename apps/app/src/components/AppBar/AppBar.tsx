...
import { Button, MaterialIcon, Tooltip, Typography } from 'ui';
	...
	return (
		<AppBarContainer>
			<Tooltip direction="bottom" tip="Home">
				<TitleContainer noMargin onClick={handleHomeClicked} variant="h6">
					{appNameTitleCase}
				</TitleContainer>
			</Tooltip>
			<ActionsGroup>
				<Tooltip direction="bottom" tip="Settings">
					<Button iconOnly onClick={handleSettingsClicked} variant="text">
