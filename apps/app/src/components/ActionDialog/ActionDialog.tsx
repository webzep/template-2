...
export const ActionDialog = forwardRef<HTMLDivElement, ActionDialogProps>(function ActionDialog(
					...
					<Scrollable>
						<Padding multiplier={4}>
							<Column align="center" justify="center">
								<Typography margin="0px 36px 0.35em" variant="h6">
									{title}
								</Typography>
								<Typography fontColor="font3" variant="body">
									{description}
								</Typography>
							</Column>
